...
import { BankIcon, BuildingOfficeIcon } from '@phosphor-icons/react';
...
const AppSidebar = () => {
  ...
  return (
    <Sidebar variant='floating'>
      <div className={cn("flex flex-col h-full", theme == "dark" && "bg-gradient-to-br from-emerald-900/45 via-zinc-900/50 to-zinc-950/70 rounded")}>
        <SidebarHeader>
